...
/**
 * Detects the version of MockServer on the classpath
 */
public final class MockServerVersionDetector
{
	private static final Logger LOG = LoggerFactory.getLogger(MockServerVersionDetector.class);
	...
	private MockServerVersionDetector()
	{
	}
